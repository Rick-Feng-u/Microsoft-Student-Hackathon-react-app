...
export declare const calloutName = "Callout";
/**
 * Properties and Tokens for FluentUI React Native Callout
 */
export declare type DirectionalHint = 'leftTopEdge' | 'leftCenter' | 'leftBottomEdge' | 'topLeftEdge' | 'topAutoEdge' | 'topCenter' | 'topRightEdge' | 'rightTopEdge' | 'rightCenter' | 'rightBottomEdge' | 'bottonLeftEdge' | 'bottomAutoEdge' | 'bottomCenter' | 'bottomRightEdge';
export declare type DismissBehaviors = 'preventDismissOnKeyDown' | 'preventDismissOnClickOutside';
...
declare type CalloutBorderTokens = Omit<IBorderTokens, keyof OmittedBorderTokens>;
...
export declare type ICalloutSlotProps = {
    root: ICalloutProps;
};
export declare type ICalloutRenderData = IRenderData<ICalloutSlotProps>;
