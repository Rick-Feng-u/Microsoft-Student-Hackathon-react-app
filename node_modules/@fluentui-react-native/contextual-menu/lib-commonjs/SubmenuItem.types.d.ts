...
export declare const submenuItemName = "submenuItem";
export interface SubmenuItemTokens extends ContextualMenuItemTokens {
    chevronColor?: string;
}
export declare type SubmenuItemProps = ContextualMenuItemProps;
...
export declare type SubmenuItemRenderData = IRenderData<SubmenuItemSlotProps, SubmenuItemState>;
...
//# sourceMappingURL=SubmenuItem.types.d.ts.map