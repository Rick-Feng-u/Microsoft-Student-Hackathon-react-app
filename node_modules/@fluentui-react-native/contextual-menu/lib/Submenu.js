...
export var Submenu = compose({
    ...
    usePrepareProps: function (userProps, useStyling) {
        var setShowMenu = userProps.setShowMenu, _a = userProps.shouldFocusOnMount, shouldFocusOnMount = _a === void 0 ? true : _a, _b = userProps.shouldFocusOnContainer, shouldFocusOnContainer = _b === void 0 ? true : _b, rest = __rest(userProps, ["setShowMenu", "shouldFocusOnMount", "shouldFocusOnContainer"]);
