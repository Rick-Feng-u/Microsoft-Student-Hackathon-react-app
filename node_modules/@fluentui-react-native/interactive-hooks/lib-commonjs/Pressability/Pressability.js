...
var Pressability = /** @class */ (function () {
        ...
        var mouseEventHandlers = react_native_1.Platform.OS === 'ios' || react_native_1.Platform.OS === 'android'
            ...
            : {
                onMouseEnter: function (event) {
                    if (HoverState_1.isHoverEnabled()) {
    ...
    Pressability.prototype._receiveSignal = function (signal, event) {
        ...
        invariant_1.default(nextState != null && nextState !== 'ERROR', 'Pressability: Invalid signal `%s` for state `%s` on responder: %s', signal, prevState, typeof this._responderID === 'number' ? this._responderID : '<<host component>>');
    ...
    Pressability.prototype._isTouchWithinResponderRegion = function (touch /* PropertyType<PressEvent, 'nativeEvent'> */, responderRegion) {
        var _a, _b, _c, _d;
        var hitSlop = InternalTypes_1.normalizeRect(this._config.hitSlop);
        var pressRectOffset = InternalTypes_1.normalizeRect(this._config.pressRectOffset);
