...
export declare type PressablePressProps = {
    /**
...
export declare type PressableFocusProps = {
    /**
...
export declare type PressableHoverProps = {
    /**
...
export declare type PressableHoverEventProps = {
    /**
...
export declare type PressabilityConfig = Readonly<PressablePressProps & PressableFocusProps & PressableHoverProps & {
    /**
...
export declare type PressabilityEventHandlers = Readonly<PressablePressProps & PressableHoverEventProps & PressableFocusProps & {
...
//# sourceMappingURL=Pressability.types.d.ts.map