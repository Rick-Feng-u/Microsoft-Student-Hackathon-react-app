...
function useAsPressable(props) {
    ...
    var pressabilityProps = usePressability_1.usePressability(__assign(__assign(__assign(__assign({}, props), hoverProps), focusProps), pressProps));
    return {
...
function useFocusState(props) {
    ...
    return [__assign(__assign({}, props), usePressability_1.usePressability(__assign(__assign({}, props), focusProps))), focusState];
}
...
function usePressState(props) {
    ...
    return [__assign(__assign({}, props), usePressability_1.usePressability(__assign(__assign({}, props), pressProps))), pressState];
}
...
function useHoverState(props) {
    var _a = useHoverHelper(props), hoverProps = _a[0], hoverState = _a[1];
    return [__assign(__assign({}, props), usePressability_1.usePressability(__assign(__assign({}, props), hoverProps))), hoverState];
}
...
function usePressableState(props) {
    ...
    var platformSupportsHover = react_native_1.Platform.OS !== 'android' && react_native_1.Platform.OS !== 'ios';
