...
export declare const linkName = "RNFLink";
/**
 * Properties for fabric native Link
 */
export declare type ILinkTokens = IForegroundColorTokens & FontTokens & IBorderTokens;
/**
 ...
 */
export declare type ILinkState = IPressableState & {
    /**
...
export declare type IWithLinkOptions<T extends object> = ILinkOptions & IWithPressableOptions<T>;
...
export declare type ILinkSlotProps = {
    root: React.PropsWithRef<ViewProps>;
    content: ITextProps;
};
export declare type ILinkRenderData = IRenderData<ILinkSlotProps, ILinkState & ILinkInfo>;
