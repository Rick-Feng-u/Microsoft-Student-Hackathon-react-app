...
export declare const MenuButtonName = "MenuButton";
...
export declare type MenuButtonSlotProps = {
...
export declare type MenuButtonRenderData = IRenderData<MenuButtonSlotProps, MenuButtonState>;
