...
export declare type PersonaSize = 'size8' | 'size24' | 'size32' | 'size40' | 'size48' | 'size56' | 'size72' | 'size100' | 'size120';
/**
 * Sets color of the coin when there is no picture
 * @deprecated Use PersonaCoinFluentColor instead.
 */
export declare type PersonaCoinColor = 'lightBlue' | 'blue' | 'darkBlue' | 'teal' | 'green' | 'darkGreen' | 'lightPink' | 'pink' | 'magenta' | 'purple' | 'orange' | 'darkRed' | 'violet' | 'lightRed' | 'gold' | 'burgundy' | 'warmGray' | 'coolGray' | 'cyan' | 'rust';
/**
 * Sets color of the coin when there is no picture. Uses fluent color names
 */
export declare type PersonaCoinFluentColor = 'cornflower' | 'blue' | 'royalBlue' | 'teal' | 'forest' | 'darkGreen' | 'berry' | 'hotPink' | 'grape' | 'purple' | 'pumpkin' | 'red' | 'burgundy' | 'orchid' | 'brass' | 'darkRed' | 'beige' | 'platinum' | 'steel' | 'brown';
export declare type PersonaPresence = 'none' | 'offline' | 'online' | 'away' | 'dnd' | 'blocked' | 'busy';
export declare type RingThickness = number | 'xSmall' | 'small' | 'medium' | 'large' | 'xlarge' | 'xxlarge';
...
export declare type IPersonaCoinRenderData = IRenderData<IPersonaCoinSlotProps, IPersonaCoinState>;
