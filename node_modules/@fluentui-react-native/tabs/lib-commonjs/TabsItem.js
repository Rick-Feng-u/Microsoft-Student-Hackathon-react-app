...
exports.TabsItem = foundation_compose_1.compose({
    ...
    usePrepareProps: function (userProps, useStyling) {
        ...
        var pressable = interactive_hooks_1.useAsPressable(__assign(__assign({}, rest), { onPress: changeSelection, onFocus: changeSelectionWithFocus, onBlur: removeFocus }));
        // Set up state.
        var state = {
        ...
        var buttonRef = react_native_1.Platform.OS === 'macos' ? componentRef : interactive_hooks_1.useViewCommandFocus(componentRef);
        ...
        var slotProps = foundation_settings_1.mergeSettings(styleProps, {
            root: __assign(__assign(__assign({}, rest), pressable.props), { ref: buttonRef, accessibilityRole: 'tab', accessibilityLabel: accessibilityLabel, accessibilityState: { disabled: userProps.disabled, selected: info.selectedKey === userProps.itemKey }, accessibilityActions: [{ name: 'Select', label: TabsItem_settings_1.tabsItemSelectActionLabel }], accessibilityPositionInSet: accessibilityPositionInSet !== null && accessibilityPositionInSet !== void 0 ? accessibilityPositionInSet : info.tabsItemKeys.findIndex(function (x) { return x == itemKey; }) + 1, accessibilitySetSize: accessibilitySetSize !== null && accessibilitySetSize !== void 0 ? accessibilitySetSize : info.tabsItemKeys.length, onAccessibilityAction: onAccessibilityAction, focusable: react_native_1.Platform.select({ default: true, macos: !userProps.disabled }) }),
