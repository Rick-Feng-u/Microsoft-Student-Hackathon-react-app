 ...
 */
export declare type FontFamilyValue = string;
/**
 ...
 */
export declare type FontFamily = keyof FontFamilies | FontFamilyValue;
/**
 * A font size value, specified in CSS pixels (px).
 */
export declare type FontSizeValuePoints = number;
/**
 ...
 */
export declare type FontSize = keyof FontSizes | FontSizeValuePoints;
/**
 * A font weight value.
 *
 ...
 * font.
 */
export declare type FontWeightValue = '100' | '200' | '300' | '400' | '500' | '600' | '700' | '800' | '900';
/**
 ...
 */
export declare type FontWeight = keyof FontWeights | FontWeightValue;
/**
 ...
 */
export declare type Variant = keyof Variants | VariantValue;
/**
...
export declare type Typography = TextStyling;
/**
 * A partially specified typography.
 */
export declare type PartialTypography = {
    [P in keyof Typography]?: Partial<Typography[P]>;
};
