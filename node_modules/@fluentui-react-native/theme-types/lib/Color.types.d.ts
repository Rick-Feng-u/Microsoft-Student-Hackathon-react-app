...
export declare type ThemeColorDefinition = Palette & {
 ...
 */
export declare type Palette = PaletteTextColors & PaletteBackgroundColors & Partial<ControlColorTokens> & Partial<AliasColorTokens>;
/**
 * A partially specified color palette.
 */
export declare type PartialPalette = Partial<Palette>;
/**
 * A color, used when defining a visual element in a theme.
 */
export declare type Color = keyof Palette | ColorValue;
