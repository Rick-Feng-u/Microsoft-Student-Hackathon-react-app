...
describe('ThemeReference tests', function () {
    ...
    it('transforms via functions correctly', function () {
        var themeRef = new ThemeReference(themeBase, function () { return ({
            colors: {
                white: 'blue',
            },
        }); });
    ...
    it('handles multiple recipes for a single reference', function () {
        var themeRef = new ThemeReference(themeBase, { colors: { white: 'black' } }, function () { return ({
            colors: { red: 'green' },
        }); });
    ...
    it('chains correctly for definitions and updates', function () {
        var baseRef = new ThemeReference(themeBase, { colors: { white: 'pink' } });
        var nextRef = new ThemeReference(baseRef, { colors: { red: 'purple' } });
        var signal = { count: 0 };
        var onChange = function () {
            signal.count++;
        };
