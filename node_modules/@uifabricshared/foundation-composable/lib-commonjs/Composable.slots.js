...
function _mergeAndFilterProps(propsBase, propsExtra, filter) {
    ...
    var props = merge_props_1.mergeProps(propsBase, propsExtra);
    if (filter && props) {
        var removeMask_1 = {};
        ...
        props = merge_props_1.mergeProps(props, removeMask_1);
    }
    return props;
}
/**
            ...
            if (composable) {
                ...
                Slots_1[slot] = _createSlotRenderFunction(function (extraProps) {
                    ...
                    if (filter || extraProps) {
                        ...
                        renderData.slotProps = foundation_settings_1.mergeSettings(renderData.slotProps, toMerge);
                    }
