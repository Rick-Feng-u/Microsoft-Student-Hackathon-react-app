...
export function renderSlot(slot, extraProps) {
    ...
    return typeof slot === 'function' && slot._canCompose
        ? slot.apply(void 0, __spreadArrays([extraProps], children)) : React.createElement.apply(React, __spreadArrays([slot, extraProps], children));
}
/**
...
export function withSlots(reactType, props) {
    ...
    return renderSlot.apply(void 0, __spreadArrays([reactType, props], children));
}
