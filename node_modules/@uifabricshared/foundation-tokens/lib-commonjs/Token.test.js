...
var MockButton_1 = require("./MockButton");
var MockTheme_1 = require("./MockTheme");
...
describe('Token settings unit tests', function () {
    test('resolve base settings', function () {
        ...
        var resolved = MockButton_1.MockButton({}, b1, MockTheme_1.theme, cache, false);
        expect(resolved).toEqual(b1resolved);
    });
    test('resolve base with recursion', function () {
        var cache = memo_cache_1.getMemoCache();
        var resolved = MockButton_1.MockButton({}, b1, MockTheme_1.theme, cache, true);
        expect(resolved).toEqual(b1resolvedRecurse);
    });
    test('two default buttons return same object', function () {
        var cache = memo_cache_1.getMemoCache();
        var resolved1 = MockButton_1.MockButton({ content: 'button1' }, b1, MockTheme_1.theme, cache, false);
        var resolved2 = MockButton_1.MockButton({ content: 'button2' }, b1, MockTheme_1.theme, cache, false);
    ...
    test('setting props that match defaults keep same object', function () {
        var cache = memo_cache_1.getMemoCache();
        var resolved1 = MockButton_1.MockButton({ content: 'button1' }, b1, MockTheme_1.theme, cache, false);
        var resolved2 = MockButton_1.MockButton({ content: 'button2', color: 'buttonText' }, b1, MockTheme_1.theme, cache, false);
        expect(resolved1).toEqual(resolved2);
        Object.getOwnPropertyNames(resolved1).forEach(function (key) {
            expect(resolved1[key]).toBe(resolved2[key]);
        });
    ...
    test('prop token overrides produce partial new object', function () {
        var cache = memo_cache_1.getMemoCache();
        var resolved1 = MockButton_1.MockButton({ content: 'button1' }, b1, MockTheme_1.theme, cache, false);
        var resolved2 = MockButton_1.MockButton({ content: 'button2', color: 'purple' }, b1, MockTheme_1.theme, cache, false);
    ...
    test('prop token overrides, multiple values are memoized', function () {
        var cache = memo_cache_1.getMemoCache();
        var resolved1 = MockButton_1.MockButton({ content: 'button1', borderRadius: 3, color: 'purple' }, b1, MockTheme_1.theme, cache, false);
        var resolved2 = MockButton_1.MockButton({ content: 'button2', color: 'purple', borderRadius: 3 }, b1, MockTheme_1.theme, cache, false);
        expect(resolved1).toEqual(resolved2);
        Object.getOwnPropertyNames(resolved1).forEach(function (key) {
            expect(resolved1[key]).toBe(resolved2[key]);
        });
    ...
    test('prop token overrides, different keys same value produce different objects', function () {
        var cache = memo_cache_1.getMemoCache();
        var resolved1 = MockButton_1.MockButton({ content: 'button1', backgroundColor: 'purple' }, b1, MockTheme_1.theme, cache, false);
        var resolved2 = MockButton_1.MockButton({ content: 'button2', color: 'purple' }, b1, MockTheme_1.theme, cache, false);
        expect(resolved1).not.toBe(resolved2);
