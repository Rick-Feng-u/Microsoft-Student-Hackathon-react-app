...
export declare type ILookupThemePart<TTheme> = (theme: TTheme) => object;
/**
...
export declare type IOperationSet<TTokens, TTheme> = IStyleFactoryOperation<TTokens, TTheme>[];
/**
 ...
 */
export declare type IStyleFactoryFunctionRaw<TProps, TTokens, TTheme> = (tokenProps: TTokens, theme: TTheme) => TProps extends object ? TProps : never;
export declare type IStyleFactoryFunction<TProps, TTokens, TTheme> = IStyleFactoryFunctionRaw<TProps, TTokens, TTheme> & {
    _keys: (keyof TTokens)[];
};
/**
 * An entry can be an individual operation, an array of operations, or a token function
 */
export declare type IStyleFactoryEntry<TProps, TTokens, TTheme> = IStyleFactoryOperation<TTokens, TTheme> | IOperationSet<TTokens, TTheme> | IStyleFactoryFunction<TProps, TTokens, TTheme>;
/**
 * This is the collection of style factories corresponding to the slots
 */
export declare type IStyleFactories<TSlotProps extends object, TTokens, TTheme> = {
 ...
 */
export declare type ITargetHasToken = (target: string, key: string) => boolean;
/**
 ...
 */
export declare type IStyleFinalizer<TProps> = (props: TProps, slotName: string) => TProps;
/**
