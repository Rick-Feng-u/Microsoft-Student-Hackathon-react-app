 ...
 */
export declare type ISettingsFromTheme<TSettings extends IComponentSettings, TTheme> = (theme: TTheme) => TSettings;
/**
 ...
 */
export declare type ISettingsEntry<TSettings extends IComponentSettings, TTheme> = TSettings | string | ISettingsFromTheme<TSettings, TTheme>;
/**
 * A function which retrieves a setting definition from a theme by name.  This is separate to allow the theming system
 * to be injected.
 */
export declare type IGetSettingsFromTheme<TSettings extends IComponentSettings, TTheme> = (theme: TTheme, name: string) => TSettings | undefined;
//# sourceMappingURL=CustomSettings.types.d.ts.map